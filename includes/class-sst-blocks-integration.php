...
// Only define the class if the WooCommerce Blocks IntegrationInterface is available
if ( interface_exists( 'Automattic\WooCommerce\Blocks\Integrations\IntegrationInterface' ) ) {
	/**
	 * Class for integrating with WooCommerce Blocks
	 */
	class SST_Blocks_Integration implements \Automattic\WooCommerce\Blocks\Integrations\IntegrationInterface {
		...
		/**
		 * Force the exemption block to be displayed on the checkout page.
		 *
		...
		public function force_exemption_block( $content ) {
			...
			$blocks = $this->insert_exemption_block( $blocks );

			return serialize_blocks( $blocks );
		}
	}
} else {
	// Fallback class when WooCommerce Blocks is not available
	class SST_Blocks_Integration {
		public function get_name() {
			return 'simple-sales-tax';
		}

		public function initialize() {
			// Do nothing when blocks are not available
		}
