...
// Only define the class if WooCommerce is loaded
if ( class_exists( 'WC_Integration' ) ) {
	class SST_Integration extends WC_Integration {
		...
		protected function get_system_status_report() {
			if ( defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '9.0', '>=' ) && class_exists( '\Automattic\WooCommerce\Utilities\RestApiUtil' ) ) {
				return wc_get_container()
					->get( \Automattic\WooCommerce\Utilities\RestApiUtil::class )
