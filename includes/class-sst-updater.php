...
/**
 * Initialize WooCommerce dependencies.
 */
function sst_init_wc_dependencies() {
...
// Only define the class if WP_Background_Process is available
if ( class_exists( 'WP_Background_Process' ) ) {
	...
	// Fallback class when WP_Background_Process is not available
	class SST_Updater {
		protected $action = 'sst_updater';
