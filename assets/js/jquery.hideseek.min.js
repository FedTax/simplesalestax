/**
 * HideSeek jQuery Plugin v1.1.1
 * https://github.com/ressio/hideseek
 *
 * Copyright 2013-2014, RESS.io
 * Licensed under the MIT license.
 *
 * PATCHED IN TAXCLOUD FOR WOOCOMMERCE v6.3.5: Replaced s.keyup(...) with s.on('keyup', ...) to
 * prevent conflicts with other plugins that may also be using jQuery.
 *
